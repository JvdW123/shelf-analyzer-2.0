...
30 Est. Linear Meters | Visual / Metadata | Estimated linear shelf meters allocated to this product or section. This can be measured or estimated from the photos based on the shelf width visible. Leave blank if not determinable.
...
Columns: The 33 columns listed above in exact order (Country, City, Retailer, Store Format, Store Name, Photo, Shelf Location, Shelf Levels, Shelf Level, Product Type, Branded/Private Label, Brand, Sub-brand, Product Name, Flavor, Facings, Price (Local Currency), Currency, Price (EUR), Packaging Size (ml), Price per Liter (EUR), Need State, Juice Extraction Method, Processing Method, HPP Treatment, Packaging Type, Claims, Bonus/Promotions, Stock Status, Est. Linear Meters, Fridge Number, Confidence Score, Notes).
